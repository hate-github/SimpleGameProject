...
public static class Клавиши
{
    ...
    public const string РУКИ = "руки";
    public const string СМЕНИТЬ = "сменить";
    ...
    public static readonly IReadOnlyList<Привязка> ВСЕ = new Привязка[]
    {
        ...
        new(СПИСОК, "мысли (телефон)", "Space"),
        ...
        new(КАРТА, "карта", "M"),
        new(КАРМАН, "карман", "I"),
        new(РУКИ, "достать или убрать из рук", "F"),
        new(СМЕНИТЬ, "взять в руки другое", "R"),
    };
