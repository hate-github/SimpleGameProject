...
public sealed class Сутки
{
    ...
    // чтобы запах не писался в журнал десять раз за день
    public ЗапахЖурнал запах_журнал { get; } = new();
}

/// <summary>Сколько строк про запах уже написано и за какой день.</summary>
public sealed class ЗапахЖурнал
{
    public int день { get; set; } = -99;
    public int строк { get; set; }
}
