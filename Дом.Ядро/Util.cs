...
public sealed class Rng
{
    ...
    public long Зерно { get; set; }

    /// <summary>
    /// Где лента стоит сейчас. Нужно сохранению: без этого продолженный
    /// прогон пойдёт другой жизнью с первого же броска. Больше её не читает
    /// никто — и не должен.
    /// </summary>
    public ulong Состояние
    {
        get => _состояние;
        set => _состояние = value;
    }
