...
//   · `погреб6`, `гараж13` — кладовая с таким `id`. Погреба теперь
//     в подвале, а гаражи за домом, и точек на них в сцене нет; имя
//     по-прежнему читается — поставьте точку, и кладовая встанет туда.

// Ловушка: свойства `[Export]` C#-скрипта, дописанные в `.tscn` руками,
// Godot молча не применяет. Ставить их надо в инспекторе.
//
