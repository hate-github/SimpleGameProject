...
//
// Замок, коробка, верстак, выключатель в гараже; печь, полка, матрас
// и окна в своей квартире. Всё, что делает дверь квартиры, делает
// и предмет: говорит, что он такое, и что-то делает по клавише действия.
// Гаражный предмет — поступок самого героя, как карман; домашний —
// место мысли: по клавише он отвечает на вопрос дня тем, что дом
// предложил сделать у этой вещи (`Дом.Экран.Места`).
//
